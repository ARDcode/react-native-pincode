...
class PINCode extends React.PureComponent {
    constructor(props) {
        ...
        this.triggerTouchID = () => {
            var _a;
            (_a = this.enterCodeRef.current) === null || _a === void 0 ? void 0 : _a.launchTouchID();
        };
